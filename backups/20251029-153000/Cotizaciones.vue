        ...
        <div class="lg:col-span-2">
          <div class="enhanced-form-card">
            ...
            <div class="form-section">
              ...
              <!-- Lista de Productos -->
              <div v-if="cotizacion.productos.length > 0" class="products-table">
                ...
                <div class="table-body">
                  <div v-for="(producto, index) in cotizacion.productos" :key="index" class="product-row">
                    ...
                    <div class="table-cell">
                      <span class="total-display">
                        Q{{ (producto.cantidad * producto.precioUnitario || 0).toFixed(2) }}
                      </span>
                    </div>
                    <div class="table-cell">
                      <button
        ...
        <div class="lg:col-span-1">
          ...
          <div v-show="pestanaActiva === 'lista'" class="tab-panel">
            ...
            <div class="cotizaciones-list">
              ...
              <div v-else class="cotizaciones-items">
                <div
                  v-for="cot in cotizacionesFiltradas.slice(0, 5)"
                  :key="cot.id"
                ...
                >
                  ...
                  <div class="item-actions">
                    <button @click.stop="verCotizacion(cot)" class="item-action-btn view" title="Ver PDF">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                      </svg>
                    </button>
                    <button @click.stop="editarCotizacion(cot)" class="item-action-btn edit" title="Editar">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                      </svg>
                    </button>
                    <button @click.stop="compartirCotizacion(cot)" class="item-action-btn share" title="Compartir PDF">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                      </svg>
                    </button>
                    <button @click.stop="imprimirCotizacion(cot)" class="item-action-btn print" title="Imprimir">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                      </svg>
                    </button>
                    <button @click.stop="confirmarEliminarCotizacion(cot)" class="item-action-btn delete" title="Eliminar">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
.cotizacion-item {
  @apply p-5 rounded-2xl cursor-pointer border-2;
  background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%);
  border-color: #e2e8f0;
  box-shadow:
    0 4px 16px rgba(0, 0, 0, 0.04),
...
.cotizacion-item:hover {
  ...
  border-color: #10b981;
  box-shadow:
    0 8px 28px rgba(16, 185, 129, 0.15),
    0 0 0 1px rgba(255, 255, 255, 0.9) inset;
...
.item-actions {
  ...
  border-image: linear-gradient(90deg, rgba(16, 185, 129, 0.2), rgba(16, 185, 129, 0)) 1;
}

.item-action-btn {
  @apply flex-1 py-2.5 px-3 rounded-xl font-bold text-sm text-center cursor-pointer border-2;
  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
...
.item-action-btn.print {
  @apply bg-gradient-to-r from-purple-500 to-purple-600 text-white border-purple-600;
}
