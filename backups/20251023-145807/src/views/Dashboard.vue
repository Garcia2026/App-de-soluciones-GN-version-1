...
const createSalesChart = () => {
  if (salesChart.value) {
    ...
    salesChartInstance = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: [obtenerMesActual(), 'Jul', 'Jun', 'May', 'Abr', 'Mar', 'Feb', 'Ene', 'Dic'],
        datasets: [
          {
            label: 'Ingresos',
            data: [totalIngresosMes.value || 0, 9200, 7800, 10500, 9800, 11200, 10800, 9500, 12000],
          ...
          {
            label: 'Gastos',
            data: [totalGastosMes.value || 0, 8500, 6200, 7800, 6500, 8000, 7200, 6500, 8000],
...
const createBalanceChart = () => {
  if (balanceChart.value) {
    ...
    balanceChartInstance = new Chart(ctx, {
      type: 'line',
      data: {
        labels: ['Mar', 'Abr', 'May', 'Jun', 'Jul', obtenerMesActual()],
        datasets: [{
          label: 'Balance Mensual',
          data: [balanceDelMes.value || 0, 15800, 18200, 16900, 19500, 22300],
          borderColor: '#10b981',
